package org.example.Home_work_Java_Exep.Seminar_3.View;

import org.example.Home_work_Java_Exep.Seminar_3.Controller.Controller;

import java.util.Scanner;

// TODO: 02.08.2023 Напишите приложение, которое будет запрашивать у пользователя следующие
//  данные в произвольном порядке, разделенные пробелом (данные вводятся одной строкой без запятых):
